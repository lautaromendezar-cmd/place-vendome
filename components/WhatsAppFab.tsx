...
export default function WhatsAppFab({ config }: { config: WhatsAppConfig }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-13 w-13 items-center justify-center rounded-full border border-gold/60 bg-ink/90 text-gold shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-gold hover:text-ink md:bottom-7 md:right-7"
    >
